...
public class League_6_7 {
    public static void main(String[] args) {
       ...
       /* for (Player player : Team1.playerArray){
        ...
        for (Player thePlay : team2.playerArray) {
            if (thePlay.PlayerName.matches("(.*)Sab(.*)")) {
                System.out.println("Found: " + thePlay.PlayerName);
                System.out.println("First Name is: " + thePlay.PlayerName.split(" ")[0]);
                System.out.println("Last Name is: " + thePlay.PlayerName.split(" ")[1]);
            }
        }
        System.out.println("------");
        StringBuilder familyNameFirst = new StringBuilder();
        for (Player thePlay : Team1.playerArray) {
            String name[] = thePlay.PlayerName.split(" ");
        ...
        System.out.println("------");
        StringBuilder familyNameFirst1 = new StringBuilder();
        for (Player thePlay : Team1.playerArray) {
            String name[] = thePlay.PlayerName.split(" ");
            familyNameFirst1.append(name[1]);
            familyNameFirst1.append(",");
            familyNameFirst1.append(name[0]);
            System.out.println(familyNameFirst1);

            familyNameFirst1.delete(0, familyNameFirst1.length());
        }
    }
